...
class TaskAdapter(
    ...
    //TODO 8 : Create and initialize ViewHolder - FINISHED
    ...
    override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
        ...
        //TODO 9 : Bind data to ViewHolder (You can run app to check) - FINISHED
        holder.bind(task)
        when {
            //TODO 10 : Display title based on status using TitleTextView - FINISHED
            task.isCompleted -> {
                //DONE
